                ...
                <ul class="space-y-4">
                    <?php $__currentLoopData = $events; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li class="border-b pb-2 relative">
                            <h2 class="text-lg font-bold"><?php echo e($event['summary']); ?></h2>
                            <p class="text-sm text-gray-500">Date: <?php echo e($event['eventDateTime']); ?></p>
                            <a href="/events/delete?id=<?php echo e($event['id']); ?>" class="absolute right-4 top-2 cursor-pointer hover:underline">
                                Delete
                            </a>
                        </li>
...
<?php /**PATH /Users/sandipshrestha/Projects/Sandip/PHP/php-google-calendar/views/events/list.blade.php ENDPATH**/ ?>